            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline card-info">
                        ...
                        <form action="{{route('customer.update', $customer)}}" method="POST" enctype="multipart/form-data" role="form">
                            @csrf @method('PATCH')
                            <div class="card-body">
                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <input size="2" value="{{old('npwp.0', substr($customer->getNPWP(),0,2))}}" type="text" name="npwp[]"  class="form-control mr-2" pattern="^[0-9]{2}$">
                                        <input type="hidden" class="form-control" name="npwp[]" value=".">
                                        <label class="mr-2">.</label>
                                        <input size="3" value="{{old('npwp.2', substr($customer->getNPWP(),2,3))}}" type="text" name="npwp[]"  class="form-control mr-2" pattern="^[0-9]{3}$">
                                        <input type="hidden" class="form-control" name="npwp[]" value=".">
                                        <label class="mr-2">.</label>
                                        <input size="3" value="{{old('npwp.4', substr($customer->getNPWP(),5,3))}}" type="text" name="npwp[]"  class="form-control mr-2" pattern="^[0-9]{3}$">
                                        <input type="hidden" class="form-control" name="npwp[]" value=".">
                                        <label class="mr-2">.</label>
                                        <input size="1" value="{{old('npwp.6', substr($customer->getNPWP(),8,1))}}" type="text" name="npwp[]"  class="form-control mr-2" pattern="^[0-9]{1}$">
                                        <input type="hidden" class="form-control" name="npwp[]" value="-">
                                        <label class="mr-2">-</label>
                                        <input size="3" value="{{old('npwp.8', substr($customer->getNPWP(),9,3))}}" type="text" name="npwp[]"  class="form-control mr-2" pattern="^[0-9]{3}$">
                                        <input type="hidden" class="form-control" name="npwp[]" value=".">
                                        <label class="mr-2">.</label>
                                        <input size="3" value="{{old('npwp.10', substr($customer->getNPWP(),12,3))}}" type="text" name="npwp[]"  class="form-control" pattern="^[0-9]{3}$">
                                    </div>
                                </div>
                                @error('npwp')
                                <div class="form-group">
